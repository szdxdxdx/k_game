...
struct k_room_callback *k_add_room_step_begin_callback(void *data, void (*fn_callback)(void *data)) {
    ...
    return k__add_room_step_callback(&room->step_begin_callback_manager, room, data, fn_callback);
}

struct k_room_callback *k_add_room_alarm_callback(void *data, void (*fn_callback)(void *data, int timeout_diff), int delay_ms) {
    struct k_room *room = k__game.current_room;
    return k__add_room_alarm_callback(&room->alarm_callback_manager, room, data, fn_callback, delay_ms);
}

struct k_room_callback *k_add_room_step_callback(void *data, void (*fn_callback)(void *data)) {
    struct k_room *room = k__game.current_room;
    return k__add_room_step_callback(&room->step_callback_manager, room, data, fn_callback);
}

struct k_room_callback *k_add_room_draw_callback(void *data, void (*fn_callback)(void *data), int z_group, int z_layer) {
    struct k_room *room = k__game.current_room;
    return k__add_room_draw_callback(&room->draw_callback_manager, room, data, fn_callback, z_group, z_layer);
}

struct k_room_callback *k_add_room_step_end_callback(void *data, void (*fn_callback)(void *data)) {
    struct k_room *room = k__game.current_room;
    return k__add_room_step_callback(&room->step_end_callback_manager, room, data, fn_callback);
}

void k_del_room_callback(struct k_room_callback *callback) {

    if (NULL != callback)
        k__del_callback(callback->base);
}
...
struct k_object_callback *k_object_add_step_begin_callback(struct k_object *object, void (*fn_callback)(struct k_object *object)) {
    return k__add_object_step_callback(&object->room->step_begin_callback_manager, object, fn_callback);
}
...
struct k_object_callback *k_object_add_alarm_callback(struct k_object *object, void (*fn_callback)(struct k_object *object, int timeout_diff), int delay_ms) {
    return k__add_object_alarm_callback(&object->room->alarm_callback_manager, object, fn_callback, delay_ms);
}

struct k_object_callback *k_object_add_step_callback(struct k_object *object, void (*fn_callback)(struct k_object *object)) {
    return k__add_object_step_callback(&object->room->step_callback_manager, object, fn_callback);
}
...
struct k_object_callback *k_object_add_draw_callback(struct k_object *object, void (*fn_callback)(struct k_object *object), int z_group, int z_layer) {
    return k__add_object_draw_callback(&object->room->draw_callback_manager, object, fn_callback, z_group, z_layer);
}

struct k_object_callback *k_object_add_step_end_callback(struct k_object *object, void (*fn_callback)(struct k_object *object)) {
    return k__add_object_step_callback(&object->room->step_end_callback_manager, object, fn_callback);
}
...
struct k_component_callback *k_component_add_step_begin_callback(struct k_component *component, void (*fn_callback)(struct k_component *component)) {
    return k__add_component_step_callback(&component->object->room->step_begin_callback_manager, component, fn_callback);
}
...
struct k_component_callback *k_component_add_alarm_callback(struct k_component *component, void (*fn_callback)(struct k_component *component, int timeout_diff), int delay_ms) {
    return k__add_component_alarm_callback(&component->object->room->alarm_callback_manager, component, fn_callback,
    delay_ms);
}
...
struct k_component_callback *k_component_add_step_callback(struct k_component *component, void (*fn_callback)(struct k_component *component)) {
    return k__add_component_step_callback(&component->object->room->step_callback_manager, component, fn_callback);
}
...
struct k_component_callback *k_component_add_draw_callback(struct k_component *component, void (*fn_callback)(struct k_component *component), int z_group, int z_layer) {
    return k__add_component_draw_callback(&component->object->room->draw_callback_manager, component, fn_callback,
    z_group, z_layer);
}
...
struct k_component_callback *k_component_add_step_end_callback(struct k_component *component, void (*fn_callback)(struct k_component *component)) {
    return k__add_component_step_callback(&component->object->room->step_end_callback_manager, component, fn_callback);
}
