...
void k__room_init_enter_callbacks_storage(struct k_room *room) {
    struct k_room_enter_callbacks_storage *storage = &room->enter_callbacks;
...
void k__room_clean_enter_callbacks_storage(struct k_room *room) {
    ...
    for (k_list_for_each_s(&storage->list, iter_node, next)) {
        ...
        callback = container_of(iter_node, struct k_room_enter_callback, iter_node);
...
static void fn_del_self(struct k_room_callback *self) {
    ...
    struct k_room_enter_callback *callback;
    callback = container_of(self, struct k_room_enter_callback, impl);
