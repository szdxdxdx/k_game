...
#define k_log_trace(fmt, ...) k__log(K_LOG_LEVEL_TRACE, K__FILE_PATH, __LINE__, fmt, ##__VA_ARGS__)
#define k_log_debug(fmt, ...) k__log(K_LOG_LEVEL_DEBUG, K__FILE_PATH, __LINE__, fmt, ##__VA_ARGS__)
#define k_log_info(fmt, ...)  k__log(K_LOG_LEVEL_INFO , K__FILE_PATH, __LINE__, fmt, ##__VA_ARGS__)
#define k_log_warn(fmt, ...)  k__log(K_LOG_LEVEL_WARN , K__FILE_PATH, __LINE__, fmt, ##__VA_ARGS__)
