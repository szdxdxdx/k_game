...
struct k_int_intrusive_map_node *k_int_intrusive_map_put(struct k_int_intrusive_map *map, int key, struct k_int_intrusive_map_node *node);
...
#define k_int_intrusive_map_node_container_of(hash_list_iter, type, member) \
    container_of(container_of((hash_list_iter), struct k_int_intrusive_map_node, list_node), type, member)
