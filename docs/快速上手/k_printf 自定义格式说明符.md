@page k_printf_example 自定义 k_printf 的格式说明符

下述示例是完整的代码，教你如何自定义 k_printf 的格式说明符。
...
/* 匹配自定义格式说明符（版本一）
 * 
 * 你可以使用 if-else 与 switch-case 手动哈希，提高识别效率。
 */
...
/* 匹配自定义格式说明符（版本二）
 * 
 * 若想省事，你可以使用 `k_printf_match_spec_helper()`
 */
