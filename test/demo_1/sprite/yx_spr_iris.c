...
static struct k_sprite *load_gun(const char *filepath, int frames_num, int delay) {
...
static struct k_sprite *load_bullet(const char *filepath, int frames_num, int delay) {
...
int yx_load_spr_iris(void) {
    ...
    yx_spr_iris_gun = load_gun("./demo_1/sprite/iris/gun.png", 1, 32);
    yx_spr_iris_bullet = load_bullet("./demo_1/sprite/iris/bullet.png", 1, 32);
    return 0;
}
